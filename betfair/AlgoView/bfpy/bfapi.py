...
class BfApi(object):
    ...
    _serviceDefs = [
        ...
        GlobalServiceDef('getActiveEventTypes', requestName='GetEventTypesReq', skipErrorCodes=['NO_RESULTS'], arrays='eventTypeItems'),
        GlobalServiceDef('getAllCurrencies', requestName='GetCurrenciesReq', arrays='currencyItems'),
        GlobalServiceDef('getAllCurrenciesV2', requestName='GetCurrenciesV2Req', arrays='currencyItems', postProc=[ProcGetAllCurrenciesV2()]),
        GlobalServiceDef('getAllEventTypes', requestName='GetEventTypesReq', skipErrorCodes=['NO_RESULTS'], arrays='eventTypeItems'),
        ExchangeServiceDef('getAllMarkets', postProc=[ProcAllMarkets()]),
        ExchangeServiceDef('getBet', skipErrorCodes=['NO_RESULTS'], arrays='bet.matches', weight=1),
        ...
        ExchangeServiceDef('getBetMatchesLite', skipErrorCodes=['NO_RESULTS'], arrays='matchLites', weight=1),
        ...
        ExchangeServiceDef('getCurrentBets', skipErrorCodes=['NO_RESULTS'], arrays='bets', postProc=[ProcCurrentBets()],
                           weight=-1,
                           detailed=False, orderBy='NONE', marketId=0, recordCount=0, startRecord=0, noTotalRecordCount=True),
        ExchangeServiceDef('getCurrentBetsLite', skipErrorCodes=['NO_RESULTS'], arrays='betLites', weight=-1,
        ...
        ExchangeServiceDef('getDetailAvailableMarketDepth', serviceName='getDetailAvailableMktDepth',
                           ...
                           arrays='priceItems', weight=1, asianLineId=0),
        GlobalServiceDef('getEvents', skipErrorCodes=['NO_RESULTS'], arrays=['eventItems', 'marketItems']),
        ExchangeServiceDef('getInPlayMarkets', postProc=[ProcAllMarkets()]),
        ExchangeServiceDef('getMarket', arrays=['market.runners', 'market.eventHierarchy'], postProc=[ProcMarket()], includeCouponLinks=False),
        ExchangeServiceDef('getMarketInfo'),
        ExchangeServiceDef('getMarketPrices',
                           arrays=['marketPrices.runnerPrices', 'marketPrices.runnerPrices.bestPricesToBack', 'marketPrices.runnerPrices.bestPricesToLay'],
                           postProc=[ProcMarketPrices()], weight=1),
        ExchangeServiceDef('getMarketPricesCompressed', postProc=[ProcMarketPricesCompressed()], weight=1),
        ExchangeServiceDef('getMarketTradedVolume', skipErrorCodes=['NO_RESULTS', 'MARKET_CLOSED'], arrays='priceItems',
        ...
        ExchangeServiceDef('getMUBets', skipErrorCodes=['NO_RESULTS'], arrays='bets',
                           preProc=[PreMuBets()], weight=-1,
                           betStatus='MU', excludeLastSecond=False, orderBy='BET_ID', recordCount=200,
                           sortOrder='ASC', startRecord=0),
        ExchangeServiceDef('getMUBetsLite', skipErrorCodes=['NO_RESULTS'], arrays='betLites',
                           preProc=[PreMuBets()], weight=-1,
                           betStatus='MU', excludeLastSecond=False, orderBy='BET_ID', recordCount=200,
                           sortOrder='ASC', startRecord=0),
        ExchangeServiceDef('getMarketProfitAndLoss', skipErrorCodes=['MARKET_CLOSED', 'INVALID_MARKET'],
                           arrays='annotations', preProc=[PreProcMarketProfitAndLoss()], postProc=[ProcMarketProfitAndLoss()], weight=1,
                           includeBspBets=False, includeSettledBets=False, netOfCommission=False),
        ExchangeServiceDef('getPrivateMarkets', skipErrorCodes=['NO_RESULTS'], arrays='privateMarkets',
                           preProc=[PreProcPrivateMarkets()], marketType='O'),
        ExchangeServiceDef('getSilks', arrays=['marketDisplayDetails', 'marketDisplayDetails.racingSilks']),
        ExchangeServiceDef('getSilksV2', arrays=['marketDisplayDetails', 'marketDisplayDetails.racingSilks']),

        # ######################,
        # Bet Placement API Services
        # ######################
        ExchangeServiceDef('cancelBets', arrays='betResults'),
        ExchangeServiceDef('cancelBetsByMarket', arrays='results'),
        ExchangeServiceDef('placeBets', arrays='betResults'),
        ExchangeServiceDef('updateBets', arrays='betResults'),
        ...
        ExchangeServiceDef('getAccountStatement', skipErrorCodes=['NO_RESULTS'],
                           arrays='items', preProc=[PreAccountStatement()],
                           itemsIncluded='EXCHANGE', startRecord=0, recordCount=1, ignoreAutoTransfers=True),
        GlobalServiceDef('getPaymentCard', arrays='paymentCardItems'),
        GlobalServiceDef('getSubscriptionInfo', arrays=['subscriptions', 'subscriptions.services']),
        GlobalServiceDef('modifyPassword'),
        GlobalServiceDef('modifyProfile'),
        GlobalServiceDef('retrieveLIMBMessage', arrays='retrieveCardBillingAddressCheckItems'),
        ...
        VendorServiceDef('getVendorUsers', arrays='vendorUsers', usernameSearchModifier='CONTAINS', customFieldSearchModifier='CONTAINS', status='ACTIVE'),
        VendorServiceDef('getVendorAccessRequests', arrays='vendorAccessRequests', status='ACTIVE'),
        VendorServiceDef('getSubscriptionInfoVendor', requestName='GetSubscriptionInfoReqVendor', username=''),
        VendorServiceDef('getVendorInfo', arrays='vendorInfo'),
        ]
