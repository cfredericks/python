...
from simsession import SimSession
...
class SimSessionPanel(AbstractSessionPanel):
    def __init__(self, parent):
        super(SimSessionPanel, self).__init__(parent, SimSession(parent))
        self.InitUI()
    ...
    def InitUI(self):
        ...
        hbox1.Add(st1)
        self.txtUser = wx.TextCtrl(self, value="USERNAME", size=wx.Size(200, 20))
